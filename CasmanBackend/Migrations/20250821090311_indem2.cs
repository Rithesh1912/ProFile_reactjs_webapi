...
{
    /// <inheritdoc />
    public partial class indem2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    case_cat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    case_spl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    case_prac = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Def_Org = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Def_Org_Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Def_Order = table.Column<int>(type: "int", nullable: true),
                    Valid = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_def_org", x => x.Def_Org);
                });
